...
export function AdminShell({ title, titleFont = 'serif', children }: AdminShellProps) {
  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-40 -ml-4 -mr-4 -mt-10 mb-6 flex items-center justify-between border-b border-border bg-surface/95 px-4 py-2.5 shadow-sm backdrop-blur lg:-ml-8 lg:justify-end">
